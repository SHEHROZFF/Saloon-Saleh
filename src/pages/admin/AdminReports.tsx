                    ...
                    >
                        {isStaffLoading ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {staff.map((s, idx) => (
                                    <div key={idx} className="bg-salon-surface/40 border border-salon-golden/10 rounded-lg p-8 hover:border-salon-golden/30 transition-all group relative overflow-hidden">
                                        {/* Rank Badge */}
                                        <div className="absolute -right-4 -top-4 w-16 h-16 bg-salon-golden/5 flex items-center justify-center rotate-45 text-salon-golden text-xl font-serif group-hover:bg-salon-golden group-hover:text-black transition-all">
                                        ...
                                        <div className="flex items-center gap-4 mb-8">
                                            ...
                                            <div>
                                                <h4 className="text-lg font-serif text-salon-primary group-hover:text-salon-golden transition-colors">{s.name}</h4>
